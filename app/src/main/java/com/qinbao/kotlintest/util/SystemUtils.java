package com.qinbao.kotlintest.util;
...
public class SystemUtils {
    ...
    public static int getMinDp(Activity activity) {
        ...
        Log.e("SystemUtils", "支持最小dp:"+smallestWidthDP);
    ...
    public static int getWidthPixels(Activity activity) {
        DisplayMetrics dm = new DisplayMetrics();
        activity.getWindowManager().getDefaultDisplay().getMetrics(dm);
        Log.e("SystemUtils", "获取分辨率_宽:"+dm.widthPixels);
    ...
    private static String getAppUUid(Context context) {
        SharedPreferences mySharedprefence = context.getSharedPreferences("setting", Activity.MODE_PRIVATE);
        String uuid=mySharedprefence.getString("app_uuid","");
        if (TextUtils.isEmpty(uuid)) {
